  ...
  async  function addcart(){
      let flag = false;
         ...
         if(flag === false){
          ...
          await axios.post(`https://purple-journalist-dmoxo.pwskills.app:5000/Meesho/AddtoCart/${localStorage.getItem('token')}?Price=${data.price}&ProductName=${data.Name}&Url=${data.url}&Qty=0`)
